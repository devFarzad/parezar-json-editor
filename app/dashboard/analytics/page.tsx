...
export default function AnalyticsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-card-title">Analytics</h1>
        <p className="text-muted-foreground mt-2">Monitor your JSON file usage and performance metrics</p>
      </div>
