...
const rolePermissions: Record<UserRole, string[]> = {
  admin: ['/dashboard', '/dashboard/aws-files', '/dashboard/analytics', '/dashboard/users', '/dashboard/notification-templates', '/dashboard/settings'],
  operator: ['/dashboard', '/dashboard/aws-files', '/dashboard/analytics', '/dashboard/notification-templates', '/dashboard/settings'],
